      ...
      <div className="container px-4 pt-10 mx-auto sm:px-6 lg:px-8">
        <div className="flex flex-col items-center justify-between gap-4 pb-6 border-b border-blue-200 lg:flex-row">
          ...
          <div className="flex w-full lg:w-auto">
            ...
            />
            <button className="px-6 py-2 font-medium text-white rounded-r-full bg-lime-500 hover:bg-lime-600">
              Subscribe Now
            </button>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 gap-8 py-10 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <button className="px-5 py-2 transition border border-orange-400 rounded-full text-lime-400 hover:bg-orange-400 hover:text-white">
              Read More
            </button>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link to="/faq" className="hover:text-lime-400">FAQs & Help</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link to="/customer-profile" className="hover:text-lime-400">My Account</Link></li>
              <li><Link to="/shop-detail" className="hover:text-lime-400">Shop details</Link></li>
              <li><Link to="/cart" className="hover:text-lime-400">Shopping Cart</Link></li>
              <li><Link to="/customer-profile/wishlist" className="hover:text-lime-400">Wishlist</Link></li>
              <li><Link to="/customer-profile/my-orders" className="hover:text-lime-400">Order History</Link></li>
            </ul>
          </div>
        ...
        <div className="flex flex-col items-center justify-between py-4 text-sm text-center text-gray-600 border-t border-blue-200 lg:flex-row">
          <p>
            © <span className="text-lime-400">DMart</span>, All rights reserved.
          </p>
          <p>
            Designed by <span className="text-lime-400">DMart Team</span> 
          </p>
        </div>
      </div>
    </footer>
